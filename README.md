...
## Overview
This is a ready-to-run React portfolio project for **Bezalel Vivian Sales S**, built as a full project structure (like create-react-app).
It uses a dark theme, responsive layout, and includes Framer Motion for animations.
